...
Use the brief's language, audience, objective and requested slide count, counting covers and references. Give each slide a distinct purpose. Select layouts from cover, statement, columns, chart, diagram, scene, math, image, references or existing project templates.
